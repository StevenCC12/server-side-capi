...
// ---------------------------
// 5) Fire Lead Event (UPDATED with Qualifying Question - VARIANT 2)
// ---------------------------
function fireLeadEvent() {
  ...
  // ---------------------------
  // NEW: Check for Qualifying Radio Button (FOR SECOND OPT-IN PAGE)
  // ---------------------------
  // ID for this page's radio button: "20 000 SEK eller mer_WP1s0IK166ih8iIVUhdM_1_beerxtcw1lc"
  const qualifyingRadioButton = document.querySelector("#\\32 0\\ 000\\ SEK\\ eller\\ mer_WP1s0IK166ih8iIVUhdM_1_beerxtcw1lc");

  if (!qualifyingRadioButton || !qualifyingRadioButton.checked) {
    // console.log("Qualifying radio button '20 000 SEK eller mer' is not selected, aborting lead event.");
    return; 
  }
