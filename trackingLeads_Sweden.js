...
// ---------------------------
// 5) Fire Lead Event (UPDATED with Qualifying Question)
// ---------------------------
function fireLeadEvent() {
  ...
  // ---------------------------
  // NEW: Check for Qualifying Radio Button
  // ---------------------------
  const qualifyingRadioButton = document.querySelector("#\\32 0\\ 000\\ SEK\\ eller\\ mer_WP1s0IK166ih8iIVUhdM_1_vdc3xacr1r");
